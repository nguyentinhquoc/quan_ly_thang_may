  ...
  if ($googlemaps.length && window.google) {
    ...
    $googlemaps.forEach(function (itm) {
      ...
      var mapOptions = {
        ...
        styles:
          utils.isDark() === 'dark' ? mapStyles.Cobalt : mapStyles[mapStyle],
      }
      ...
      themeController &&
        themeController.addEventListener('clickControl', function (_ref4) {
            ...
            if (list) {
              if (bulkSelect.checked) {
                list.items.forEach(function (item) {
                  item.elm.querySelector('[data-bulk-select-row]').checked =
                    true
                })
              } else {
                list.items.forEach(function (item) {
    ...
    if (tinymces.length) {
      ...
      window.tinymce.init({
        ...
        content_style: '\n          .mce-content-body {\n            color: '
          ...
          .concat(utils.getColor('tinymce-bg'), ';\n          }\n        '),
        mobile: {
          theme: 'mobile',
          toolbar: ['undo', 'bold'],
        },
...
var appCalendarInit = function appCalendarInit() {
  ...
  addEventModal &&
    addEventModal.addEventListener(Events.SHOWN_BS_MODAL, function (_ref15) {
        ...
        series: [
          {
            ...
            lineStyle: {
              color:
                utils.isDark() === 'light'
                  ? utils.rgbaColor(utils.getColors().white, 0.8)
                  : utils.getColors().primary,
            },
            areaStyle: {
              color: {
        ...
        tooltip: {
          ...
          formatter: function formatter(params) {
            ...
            return '<strong>'
              ...
              .concat(
                ((params.data && params.data.value / total) * 100).toFixed(2),
                '%',
              )
          },
        },
